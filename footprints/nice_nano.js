    ...
    body: p => {
      ...
      const gen_socket_row = (row_num, pin_name_left, pin_name_right, show_via_labels, show_silk_labels) => {
        ...
        let socket_row = `
          ...
          (pad ${via_num_right} smd custom (at 4.775 ${-12.7 + row_offset_y} ${p.rot + 180}) (size 0.2 0.2) (layers F.Cu F.Mask) ${net_right}
            (zone_connect 2)
            (options (clearance outline) (anchor rect))
            (primitives
              (gr_poly (pts
          ...
          (pad ${socket_hole_num_right} smd custom (at 5.5 ${-12.7 + row_offset_y} ${p.rot + 180}) (size 0.2 0.2) (layers F.Cu F.Mask) ${p.local_net(socket_hole_num_right).str}
            (zone_connect 2)
            (options (clearance outline) (anchor rect))
            (primitives
              (gr_poly (pts
          ...
          (pad ${via_num_left} smd custom (at 4.775 ${-12.7 + row_offset_y} ${p.rot + 180}) (size 0.2 0.2) (layers B.Cu B.Mask) ${net_left}
            (zone_connect 2)
            (options (clearance outline) (anchor rect))
            (primitives
              (gr_poly (pts
          ...
          (pad ${socket_hole_num_right} smd custom (at 5.5 ${-12.7 + row_offset_y} ${p.rot + 180}) (size 0.2 0.2) (layers B.Cu B.Mask) ${p.local_net(socket_hole_num_right).str}
            (zone_connect 2)
            (options (clearance outline) (anchor rect))
            (primitives
              (gr_poly (pts
        ...
        if(show_silk_labels == true) {
          socket_row += `
            ...
            (fp_text user ${net_silk_back_left} (at -3 ${-12.7 + row_offset_y} ${p.rot + 180}) (layer B.SilkS)
              (effects (font (size 1 1) (thickness 0.15)) (justify right mirror))
            )
            (fp_text user ${net_silk_back_right} (at 3 ${-12.7 + row_offset_y} ${p.rot + 180}) (layer B.SilkS)
      ...
      const instructions = `
          (fp_text user "MASTER" (at 0 0 ${p.rot + 90}) (layer F.SilkS)
            (effects (font (size 1 1) (thickness 0.15)))
          )
          (fp_text user "SLAVE" (at 0 0 ${p.rot - 90}) (layer B.SilkS)
